function RainyDay (options) {
  ...
  RainyDay.prototype.initialize = function(options) {
    ...
    this.imgDownscaled = this.customDrop || downscaleImage(this.img, 0)
    if (options.sound) {
    ...
    // Start rain engine drop size, 
    this.rain([[2, 5, 0.25]], 5)
  }
